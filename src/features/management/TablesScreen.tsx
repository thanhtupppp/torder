...
type ModalType = "add-area" | "add-table" | "edit-table" | null;
            ...
            <div className="tables-grid">
              {displayedTables.map((table) => (
                <div
                  ...
                  role="button"
                  tabIndex={0}
                  onClick={() => setActiveModal("edit-table")}
                  onKeyDown={(e) => {
                    if (e.key === "Enter" || e.key === " ")
                      setActiveModal("edit-table");
                  }}
                >
